...
A professional,  Launchpad-style application launcher for the Vaxp Desktop Environment. Built with **C11 + GTK3** using clean architecture and optimized for performance.
