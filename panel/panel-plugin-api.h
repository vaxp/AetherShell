 ...
 *
 * The panel engine reads this struct and generates SCOPED CSS keyed on
...
typedef struct {
    ...
    /* ── Surface colour (cards, inner panels) ─────────────────────────── */
...
typedef struct {
     ...
     *
     * Return NULL to inherit the panel's global stylesheet unchanged.
