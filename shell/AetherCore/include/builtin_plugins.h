...
/* =========================================================================
 * AetherShell AetherCore — Built-in Plugin Registration
 *
 * Wraps every hard-coded AetherCore component (battery, wifi, clock, etc.) in a
 * thin AetherAetherCorePluginAPIv3 struct and registers each one with the plugin
