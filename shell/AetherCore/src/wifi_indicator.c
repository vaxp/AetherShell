...
static void create_wifi_popup_window(void)
{
    ...
    AetherCore_window_backend_init_popup(GTK_WINDOW(wifi_popup),
                                    "vaxpwy-wifi",
                                    GDK_WINDOW_TYPE_HINT_POPUP_MENU,
                                    GTK_LAYER_SHELL_KEYBOARD_MODE_ON_DEMAND);
    AetherCore_window_backend_set_anchor(GTK_WINDOW(wifi_popup), GTK_LAYER_SHELL_EDGE_TOP, TRUE);
    AetherCore_window_backend_set_anchor(GTK_WINDOW(wifi_popup), GTK_LAYER_SHELL_EDGE_RIGHT, TRUE);
    AetherCore_window_backend_set_margin(GTK_WINDOW(wifi_popup), GTK_LAYER_SHELL_EDGE_TOP, 32);
    AetherCore_window_backend_set_margin(GTK_WINDOW(wifi_popup), GTK_LAYER_SHELL_EDGE_RIGHT, 0);
...
static void on_wi_clicked(GtkButton *btn, gpointer user_data)
{
    ...
    if (wifi_popup_visible) {
        ...
        AetherCore_window_backend_align_popup(GTK_WINDOW(wifi_popup), wi_btn, 300);
